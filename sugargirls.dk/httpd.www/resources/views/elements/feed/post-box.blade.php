<div class="post-box" data-postID="{{$post->id}}" >
    ...
    <div class="post-content mt-3 {{count($post->attachments) ? "mb-3" : ""}}">


        <div class="row mr-0 ml-0 text-break post-content-data {{getSetting('feed.enable_post_description_excerpts') ? 'line-clamp-3' : ''}}"
        ...
        @if(getSetting('feed.enable_post_description_excerpts'))
            <div class="text-primary pointer-cursor show-more-actions {{count($post->attachments) ? "mb-3" : ""}} d-none"
